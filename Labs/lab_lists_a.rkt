...
;; 2 PTS
(define (yoda words)
  (append    (cdr (cdr words))    (append (list (car words)) (list (car (cdr words))))   ))
...
(define (rotate c)
  (list
   c
   (append (cdr c) (list (* -1 (car c))))
   (append (list (* -1 (car c))) (list (* -1 (car (cdr c)))))
   (append (list (* -1 (car (cdr c)))) (list (car c)))                 ))
